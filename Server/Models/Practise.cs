...
            if(order==null)
                return BadRequest();
            var evt = service.SaveOrder(order);
            // return CreatedAtAction(nameof(GetBookById), new {id=book.BookId}, book);
            return Ok(evt);
        }
        [HttpPut("{id}")]
...
        // {
        //     books = new List<Book>{
        //         new Book{BookId=1, BookName="Gita", Category="Spiritual", Price=450},
        //         new Book{BookId=2, BookName="5AM Club", Category="Self help", Price=500},
 
        //     };
        // }
...
        //         new Order{OrderId=1,CustomerName="Akhila", TotalAmount=900}
        //     };
        // }
...
        public Book SaveBook(Book book)
        {
            return brepo.SaveBook(book);
        }
        public Book UpdateBook(int id, Book book)
        {
            return brepo.UpdateBook(id, book);
        }
        public bool DeleteBook(int id)
        {
            return brepo.DeleteBook(id);
        }
    }
}
 using System;
...
        public Order GetOrder(int id)
        {
            return orepo.GetOrder(id);
        }
        public Order SaveOrder(Order order)
        {
            return orepo.SaveOrder(order);
        }
        public Order UpdateOrder(int id, Order order)
        {
            return orepo.UpdateOrder(id, order);
        }
        public bool DeleteOrder(int id)
        {
            return orepo.DeleteOrder(id);
        }
    }
}
 using dotnetapp.Repository;
...
    {
        public List<MobilePhone> list = new List<MobilePhone>();
...
        {
            MobilePhone mp = list.FirstOrDefault(x=>x.MobilePhoneId==id);
            return mp;
        }
...
        public List<MobilePhone> GetMobilePhones()
        {
            return repo.GetMobilePhones();
        }
        public MobilePhone GetMobilePhone(int id)
        {
            return repo.GetMobilePhone(id);
        }
        public MobilePhone SaveMobilePhone(MobilePhone mobilePhone)
        {
            return repo.SaveMobilePhone(mobilePhone);
        }
        public MobilePhone UpdateMobilePhone(int id, MobilePhone mobilePhone)
        {
            return repo.UpdateMobilePhone(id, mobilePhone);
        }
        public bool DeleteMobilePhone(int id)
        {
            return repo.DeleteMobilePhone(id);
        }
    }
}
using System;
...
            if(ump==null)
                return NotFound();
            var evt = service.UpdateMobilePhone(id, mobilePhone);
...
        {
            var evt = service.DeleteMobilePhone(id);
            return NoContent();
        }
